...
class LoanForm extends React.Component {
	constructor(props) {
		super(props);
		// bind handlers/methods to React Component
	...
	handleSubmit(evt) {
		...
		if (!this.state.currentLoan) {
			...
			// TODO: call the external submit listener
			...
			<div>
				...
				<form onSubmit={this.handleSubmit}>
					...
					<div className="form-group">
						...
						<span className="loan-payment" id="loan-payment">
							{this.state.payment}
						</span>
						<label htmlFor="loan-cost">Cost: </label>
						<span className="loan-cost" id="loan-cost">
							{this.state.cost}
						</span>
					</div>
					...
					<button onClick={this.handleReset} type="reset" className="btn btn-info">
						Clear
					</button>
				</form>
			</div>
